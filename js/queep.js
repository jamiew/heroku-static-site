...
(function() {
  ...
  */
  var acronym_and_word_check, add_tooltips, check_single_acronym, duplicate_acronym_check, highlight_dupes, highlight_typos, highlight_word_acro_pairs, queep, spell_check,
    indexOf = [].indexOf;
